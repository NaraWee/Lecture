...
public class EmployeeDTO {
	...
	public EmployeeDTO(String empId, String empName, String empNo, String email, String phone, String deptCode,
			String jobCode, String salLevel, int salary, double bounus, String managerId, Date hireDate, Date entDate,
			String entYn) {
		super();
		this.empId = empId;
	...
	public String toString() {
		return "EmployeeDTO [empId=" + empId + ", empName=" + empName + ", empNo=" + empNo + ", email=" + email
				...
				+ ", salary=" + salary + ", bounus=" + bounus + ", managerId=" + managerId + ", hireDate=" + hireDate
