...
<body>
	...
	<!-- SelectAllEmpServlet, employeeList.jsp -->
	
	<h3>EMPLOYEE 테이블에서 신규 직원 정보 추가(필요한 정보를 입력받을 수 있는 form을 만들어보자) : /employee/insert (post)</h3>
	<!-- InsertEmpServlet views/common/successPage.jsp -->
   ...
   <!-- UpdateEmpServlet views/common/successPage.jsp -->
   <h3>EMPLOYEE 테이블에서 직원 정보 수정(사번과 변경할 정보를 입력받아 사번과 일치하는 사원의 정보 변경) : /employee/update (post)</h3>
