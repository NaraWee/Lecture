...
public class Application {
	...
	public static void main(String[] args) {
		 ...
		 * ManagerTransactionFactory : 자동 커밋
		 * 
		 * ----------------------------------------
		 ...
		 * build() : 설정에 대한 정보를 담고 있는 Configuration타입의 객체 혹은 외부 설정 파일과 연결된 스트림을 매개변수로 전달하여
		...
		/* getMapper() : Configuration에 등록된 매퍼를 동일 타입에 대해 봔한하는 메소드 */
